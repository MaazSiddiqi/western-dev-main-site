            ...
            <div className="exec-dev">
              <div className="exec">
                ...
                <div className="director">
                  Applications are now open for all Western students interested
                  in joining our executive team. Directors will be hired for
                  internal & external events, marketing, careers, and finance.
                  In our Development portfolio we'll be hiring one community
                  lead and 2 tech leads.
                  <br />
                </div>
              </div>
              <div className="dev">
                ...
                <div className="devs">
                  ...
                  students interested in building real world applications for
                  WDS, other Western Clubs and local London community groups.
                  We'll be hiring Team Leads, Developers, and Designers!
                </div>
              </div>
            </div>
